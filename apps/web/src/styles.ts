...
export const s: Styles = {
  screen: {
    ...
    justifyContent: "flex-start", padding: "32px 16px",
  ...
  title: { color: "#f97316", fontSize: 34, fontWeight: 900, margin: "0 0 6px", letterSpacing: -1 },
  ...
  progressBar: { width: 280, height: 4, background: "#1e293b", borderRadius: 999, margin: "28px auto 0", overflow: "hidden" },
  ...
  compGrid: { display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 14, marginBottom: 24 },
  ...
  motivationCard: { background: "linear-gradient(135deg, rgba(249,115,22,0.1), rgba(251,191,36,0.05))", border: "1px solid rgba(249,115,22,0.3)", borderRadius: 16, padding: "18px 24px", textAlign: "center" },
  ...
  modal: { background: "#0f172a", border: "1px solid #1e293b", borderRadius: 20, padding: 32, width: "100%", maxWidth: 400, fontFamily: "'Segoe UI', Tahoma, Arial, sans-serif" },
};
